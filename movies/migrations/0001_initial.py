# Generated by Django 3.2 on 2022-04-20 18:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='date and time of creating')),
                ('modified', models.DateTimeField(auto_now=True, verbose_name='date and time of modifying')),
                ...
                ('type', models.CharField(choices=[('movie', 'Фильм'), ('tv_show', 'ТВ-шоу')], max_length=15, verbose_name='type')),
            ],
            options={
